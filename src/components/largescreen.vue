 ...
 <div v-if="!isMobileView" class="contain" >
    ...
    <div class="border border-gray-200 p-6 sm:p-5 md:p-10 lg:p-14 ">
      ...
      <div class=" border-b  border-gray-700  ">
        ...
        <div class="mt-4 mb-4  flex flex-col">
          <span class="text-white text-sm leading-7 mr-7">Swahili : Native or bilingual proficiency</span>
          <span class="text-white text-sm leading-7 mr-7">English : Full professional proficiency</span>
          <span class="text-white text-sm leading-7 mr-7">Swedish : Professional working proficiency</span>
